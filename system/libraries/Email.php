...
class CI_Email {
	...
	var	$smtp_host		= "cloudmail3.jogjahost.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "info@horecaba.com";		// SMTP Username
	var	$smtp_pass		= "hjmsukses01";		// SMTP Password
