<div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <tbody>
                ...
                foreach ($d as $k => $v)
                {
                  $about=substr(strip_tags($v->about_us),0,100).' ...<br> <a href="javascript:aboutus(\''.$v->id.'\')"><i><small>Selengkapnya</small></i></a>';
                  echo '<tr>';
                  ...
                  echo '<td style="text-align:center"><button class="btn btn-xs btn-primary" type="button"><i class="fa fa-youtube-play"></i> Video Profil</button></td>';
                  echo '<td style="text-align:left"><button class="btn btn-xs btn-primary" type="button"><i class="fa fa-search-plus"></i> Schedule</button></td>';
