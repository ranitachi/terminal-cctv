    ...
    <div class="col-lg-12 col-xs-12">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#datas" data-toggle="tab" aria-expanded="true">Data Berita</a></li>
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="datas" style="padding-top:15px;">
                <!-- <div class="loading">
                  ...
                  <!-- <div class="spinner" id="spinnerdata">
                    <div></div>
                    <div></div>
                    <div></div>
                    <div></div>
...
<script>
  ...
  jQuery(function($){
    $('#loader-data').show();
    $('#loader-form').show();
    $('#data').load('<?=site_url()?>news/data/-1',function(){
      $('#loader-data').hide();
    });
